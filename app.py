...
# Lógica a ejecutar cuando se hace clic en el botón "Construir histograma"
if hist_button:
    ...
    # 'width='stretch'' ajusta el ancho del gráfico al contenedor
    st.plotly_chart(fig, width='stretch')


# Lógica a ejecutar cuando se hace clic en el botón "Construir gráfico de dispersión"
if disp_button:
    # Escribir un mensaje en la aplicación
    st.write(
